...
public class CandidateController {
  ...
  public ResponseEntity<Object> create(@Valid @RequestBody Candidate createCandidateRequest) {
    try {
  ...
  @ApiResponses({@ApiResponse(responseCode = "200", content = {@Content(array = @ArraySchema(schema = @Schema(implementation = Jobs.class)))})})
  @SecurityRequirement(name = "jwt_auth")
  public List<Jobs> findJobByFilter(@RequestParam String filter) {
